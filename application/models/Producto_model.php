...
class Producto_model extends CI_Model{
        ...
        public function obtener_productos()
        {
            return $this->db->query(
                'SELECT p.codigo, tp.tipo, p.precio_costo, p.color, p.detalles, p.numero, p.talle, p.publicado, p.fecha_alta, p.id_producto as "id"
                 FROM producto p
        ...
        //        'SELECT u.id_producto, u.codigo, u.id_tipo
        //         FROM producto u
